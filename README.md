...
6) Edit and Delete option is available to the user who has uploaded the file . Other users cannot edit or delete it .  ![Book detail (view of other user)](book_detail_other_user.png) 
